...
const floatPositions = [
  { top: "4%",  right: "2%",  rotate: "-5deg", delay: 0.3, float: 0    },
  { top: "38%", right: "38%", rotate: "4deg",  delay: 0.5, float: 1.2  },
  { bottom: "6%", right: "10%", rotate: "-2deg", delay: 0.7, float: 0.6 },
];
    ...
    <section className="relative min-h-[90vh] bg-black overflow-hidden flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              {titleLines.map((line, i) => (
                <span key={line} className="block overflow-hidden">
                  <motion.span
                    ...
                    initial={{ y: "110%" }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.75, delay: 0.25 + i * 0.18, ease: [0.33, 1, 0.68, 1] }}
                  >
                    {i === 1 ? (
            ...
            >
              <Link href="/products">
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                  <Button size="lg" className="bg-violet-600 hover:bg-violet-500 gap-2 shadow-lg shadow-violet-500/30 text-white font-semibold">
              ...
              <Link href="/products?category=gadgets">
                <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                  <Button size="lg" variant="outline" className="border-white/20 text-white bg-white/5 hover:bg-white/10 hover:border-white/30">
                    View Gadgets
                  </Button>
                </motion.div>
              </Link>
          ...
          {/* Right — continuously floating product cards */}
              ...
              return (
                <motion.div
                  ...
                  transition={{
                    ...
                    scale:   { duration: 0.7, delay: pos.delay },
                    y: {
                      duration: 0.7,
                      delay: pos.delay,
                      times: [0, 0.4, 0.7, 1],
                      ...
                      repeatType: "reverse",
                      ease: "easeInOut",
                      repeatDelay: pos.float,
                    },
                  }}
                  whileHover={{ scale: 1.06, rotate: "0deg", y: -6, zIndex: 10 }}
                  style={{
                    position: "absolute",
                    top:    pos.top,
                    right:  pos.right,
                ...
                >
                  <div className="relative h-36 bg-zinc-800">
                    <Image src={product.imageUrl} alt={product.name} fill sizes="208px" className="object-cover" />
