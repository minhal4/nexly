...
export default function ProductCard({ product }: Props) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      className="group bg-zinc-900 rounded-2xl overflow-hidden border border-white/8 hover:border-violet-500/40 hover:shadow-2xl hover:shadow-violet-500/10 transition-colors duration-300 flex flex-col h-full"
    >
      ...
      <div className="p-4 flex flex-col flex-1 gap-2">
        <div className="flex items-start justify-between gap-2">
          <Badge variant="secondary" className="text-xs shrink-0 bg-violet-500/10 text-violet-400 border border-violet-500/20">
